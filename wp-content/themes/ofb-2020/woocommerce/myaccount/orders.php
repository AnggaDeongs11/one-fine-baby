...
<?php else : ?>
	...
	<a class="vc_general vc_btn3 vc_btn3-size-md vc_btn3-shape-rounded vc_btn3-style-modern vc_btn3-color-grey" href="/all-products" title="One Fine Baby Shop">Start Shopping</a></div>
