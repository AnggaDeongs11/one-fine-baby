                ...
                if (!empty($filters) && ($isGrid || $isOffset || $isWooCom || $isEdd)) {
                    ...
                    if (in_array('_taxonomy_filter', $filters) && $taxFilter) {
                        ...
                        if (!$filterType || $filterType == 'dropdown') {
                            ...
                            if (!$hide_all_button) {
                                $htmlButton = "<span class='term-dropdown-item rt-filter-dropdown-item' data-term='all'><span class='rt-text'>" . __("All",
                                        "the-post-grid-pro") . "{$pAllCount}</span></span>" . $htmlButton;
                            }
                    ...
                    if (in_array('_author_filter', $filters)) {
                        ...
                        if (!$filterType || $filterType == 'dropdown') {
                            ...
                            if (!$hide_all_button) {
                                $pCountH = ($post_count ? " (<span class='rt-post-count'>{$bCount}</span>)" : null);
                                $html .= "<span class='author-button-item rt-filter-button-item {$allSelect}' data-author='all'>" . __("All",
                                        "the-post-grid-pro") . "{$pCountH}</span>";
                            }
                            $html .= $bItems;
                            $html .= "</div>";
