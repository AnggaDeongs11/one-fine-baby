	...
	<div class="quantity">
		...
		<select
			...
			if ( $product && 'yes' === get_option( 'alg_wc_pq_qty_dropdown_label_template_is_per_product', 'no' ) ) {
				$label_template_singular = get_post_meta( $product->get_id(), '_alg_wc_pq_qty_dropdown_label_template_singular', true );
				$label_template_plural   = get_post_meta( $product->get_id(), '_alg_wc_pq_qty_dropdown_label_template_plural',   true );
			}
