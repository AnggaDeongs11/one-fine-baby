	...
	function __construct() {
		$this->is_section_enabled = array(
			'min'                  => ( 'yes' === get_option( 'alg_wc_pq_min_section_enabled', 'no' ) &&
				'yes' === apply_filters( 'alg_wc_pq', 'no', 'per_item_quantity_per_product', array( 'min_or_max' => 'min' ) ) ),
			'max'                  => ( 'yes' === get_option( 'alg_wc_pq_max_section_enabled', 'no' ) &&
				'yes' === apply_filters( 'alg_wc_pq', 'no', 'per_item_quantity_per_product', array( 'min_or_max' => 'max' ) ) ),
			'step'                 => ( 'yes' === get_option( 'alg_wc_pq_step_section_enabled', 'no' ) &&
				'yes' === apply_filters( 'alg_wc_pq', 'no', 'quantity_step_per_product' ) ),
			'exact_qty_allowed'    => ( 'yes' === get_option( 'alg_wc_pq_exact_qty_allowed_section_enabled', 'no' ) &&
				'yes' === apply_filters( 'alg_wc_pq', 'no', 'exact_qty_per_product', array( 'allowed_or_disallowed' => 'allowed' ) ) ),
			'exact_qty_disallowed' => ( 'yes' === get_option( 'alg_wc_pq_exact_qty_disallowed_section_enabled', 'no' ) &&
				'yes' === apply_filters( 'alg_wc_pq', 'no', 'exact_qty_per_product', array( 'allowed_or_disallowed' => 'disallowed' ) ) ),
