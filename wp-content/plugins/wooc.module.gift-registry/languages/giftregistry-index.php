      ...
      <?php
        ...
        ?>
            <form action="" method="get">
                ...
                <input name="checkpass_giftregistry" id="checkpass_giftregistry" type="hidden" value="1"/>
...
if (isset($_REQUEST['checkpass_giftregistry'])) {
    ...
    if($checkpass_giftregistry == 0){
        echo "<b style='color: red;'>Password incorrect! Please try again.</b>";
    }
?>
    <h4 style="margin-top: 50px;">The gift registry is protected by password. Please enter the password.</h4>
    <h2>Password</h2>
...
<?php
    ...
    if(isset($_REQUEST['btnSubmit'])){
        ...
        if($password == $pass){
            ...
            echo "<script type='text/javascript'>window.location.href = '".$link."';</script>"; exit;
            ?>
    ...
    <form id="searchgiftregistry" method="POST" action="<?php echo $giftregistry_page_path ?>">
        ...
        <table class="" style="margin-top: 10px; margin-bottom: 10px;">
            <tr>
                ...
                <td><input type="text" name="grname" <?php if( isset($_SESSION['registrynamesearch'])) {?> value="<?php echo $_SESSION['registrynamesearch'] ?>" <?php }?>></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><input type="submit" name="submit" value="<?php echo __('Search gift registry' , GIFTREGISTRY_TEXT_DOMAIN) ?>"></td>
            </tr>
        </table>
    </form>
    <!-- end table of search -->
