...
jQuery( function( $ ){
    ...
    val_counter = 0;
      ...
      setTimeout(function(){
            ...
            val_counters = parseInt($('#counter').val());
            val_counter = val_counters + 1;
            $('#counter').val(val_counter);

          $(".wcv_product_attributes .attribute_taxonomy option:eq("+val_counter+")").attr("selected", "selected");
          var option = $(".wcv_product_attributes .attribute_taxonomy").val();
            if($(".wcv_product_attributes .attribute_taxonomy:last").val() == option) {
                $('.select_no_attributes').trigger('click');
                ...
                if(val_counter==4) {
                  ...
                  setTimeout(function(){
                      $('.do_variation_action').trigger('click');
                  }, 2000);
                }
            }
