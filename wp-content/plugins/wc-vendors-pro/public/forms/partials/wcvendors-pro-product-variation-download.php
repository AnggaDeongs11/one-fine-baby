<tr>
	...
	<td class="file_url_choose" width="1%"><a href="#" class="button upload_file_button"
											  ...
											  data-update="<?php esc_attr_e( 'Insert file URL', 'wcvendors-pro' ); ?>"><?php echo str_replace( ' ', '&nbsp;', __( 'Choose file', 'wcvendors-pro' ) ); ?></a>
	</td>
	<td width="1%"><a href="#" class="delete"><i class="wcv-icon wcv-icon-times"></i></a></td>
</tr>
