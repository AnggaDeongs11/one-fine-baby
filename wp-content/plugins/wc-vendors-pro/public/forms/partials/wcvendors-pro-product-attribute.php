					...
					<div class="control" data-index_value="<?php echo $i; ?>" data-taxonomy="<?php echo $taxonomy; ?>"
						...
						<?php if ( $attribute['is_taxonomy'] ) : ?>
							<?php if ( 'select' === $attribute_taxonomy->attribute_type ) : ?>
								...
								<button class="btn btn--primary d-inline-flex button select_all_attributes mt-2"><?php _e( 'Select all', 'wcvendors-pro' ); ?></button>
								<button class="btn btn--secondary d-inline-flex button select_no_attributes mt-2"><?php _e( 'Select none', 'wcvendors-pro' ); ?></button>
