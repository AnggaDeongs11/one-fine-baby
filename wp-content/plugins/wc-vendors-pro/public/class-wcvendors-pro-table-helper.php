...
class WCVendors_Pro_Table_Helper {
	...
	public function set_defaults() {
		...
		$stock = isset($_GET['wcv-stocks']) ? $_GET['wcv-stocks'] : '';
	 ...
	 * @since    1.0.0
	 */
	public function display($table = true) {
...
//		do_action( 'wcvendors_pro_table_after_' . $this->id );
	...
	public function display_grid() {
		...
		include apply_filters( 'wcvendors_pro_table_display_rows_path', 'partials/helpers/table/wcvendors-pro-table-grid.php' );
