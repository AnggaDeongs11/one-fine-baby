...
class WCVendors_Pro_Admin_Setup_Wizard {
	...
	public function setup_wizard() {
		...
		wp_enqueue_style(
			'wcvendors-pro-setup',
			plugin_dir_url( __FILE__ ) . 'assets/css/src/wcvendors-pro-setup.css',
			array(
				'dashicons',
				'install',
			),
		...
		wp_register_script(
			'wcvendors-pro-setup',
			plugin_dir_url( __FILE__ ) . 'assets/js/src/wcvendors-pro-setup.js',
			array(
				'jquery',
				'wc-enhanced-select',
				'jquery-blockui',
	...
	public function wcv_setup_pages() {
		...
		$wcvendors_dashboard_page_ids = (array) get_option( 'wcvendors_dashboard_page_id' );
