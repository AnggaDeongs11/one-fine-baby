(function( $ ) {
	...
	$('#_wcv_commission_type').on('change', function( ) {
		...
		toggle_commission_fields( commission_type, amount_row, percent_row, fee_row, vendor_sales, product_sales, product_price );
	...
	function toggle_commission_fields( commission_type, amount_row, percent_row, fee_row, vendor_sales, product_sales, product_price ) {
	...
	// Product SEO
	$('#wcvendors_hide_product_seo').on('change', function(e){
		if($(this).is(':checked')){
			$(this).parent().parent().parent().find('.wcv_admin_checkbox').not($(this)).attr('disabled', 'disabled').attr('checked', false);
			$(this).removeAttr('disabled');
		}else{
			$(this).parent().parent().parent().find('.wcv_admin_checkbox').removeAttr('disabled');
		}
	});
