...
Tags: woocommerce, loyalty, rewards, coupon, points, social medias, badges, achievements, fidélité, récompenses, bon d'achat, daily, temporary, success, badges, events, anniversary, achievements, succès, événements, referral, chinese, spanish, french
...
[youtube https://www.youtube.com/watch?v=AkzIR7q19B0]
...
For more information, visit our website [Long Watch Plugins - Documentation](https://plugins.longwatchstudio.com/en/documentation-en/woorewards/)
...
* Translated in multiple languages : English, Spanish, Chinese, French, Finnish
* WPML Compatibility

== WooRewards Pro, the next level ==

**[WooRewards Pro](https://plugins.longwatchstudio.com/en/product/woorewards-en/)** adds a ton of new features to WooRewards:
...
Test WooRewards Pro for free for 30 days : **[https://plugins.longwatchstudio.com/en/product/woorewards-en/](https://plugins.longwatchstudio.com/en/product/woorewards-en/)**
...
1. Use the WooCommerce->WooRewards screen to configure the plugin
