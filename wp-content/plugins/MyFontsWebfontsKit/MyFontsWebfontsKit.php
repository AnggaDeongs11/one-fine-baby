...
/*
Plugin Name: MyFontsWebfontsKit #3769676
...
add_action( 'admin_init', array('MyFontsInstaller_3769676','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_3769676','mffonts_loadupWebfonts' ));